...
candidate_info = {
    ...
    "candidate_name": "汪展鹏",
    "candidate_email": "1847092142@qq.com",
    "scheduled_time": "2026-06-30 15:00",
    "job_title": "电气工程师",
    "jd": jd_content
}
...
print(f"候选人ID: {candidate_info['candidate_id']}")
print(f"邮箱: {candidate_info['candidate_email']}")
...
if result.get("success"):
    ...
    output_file = r"c:\Users\36368\Desktop\trae-agent\generator\001\interview_room_汪展鹏_电气工程师_cand_wzp_003_new.json"
