...
def update_candidate():
    ...
    try:
        # 直接更新状态，允许从pending或room_created状态更新
        candidate = candidate_model.get_by_id(candidate_id)
        if candidate and candidate['status'] in ['pending', 'room_created']:
            from datetime import datetime
            ...
            return api_error("候选人不存在或状态不允许更新", "CANDIDATE_STATUS_CHANGED", 400)
    except Exception as e:
