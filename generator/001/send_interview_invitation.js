 ...
 * 生成面试时间选择链接
 */
function generateTimeSelectLink(applicationId) {
  // 使用Cloudflare Tunnel服务
  return `https://signing-let-habits-kept.trycloudflare.com/form?candidate_id=${applicationId}`;
}
      ...
      <div style="padding: 28px; background: #fff;">
        ...
        <table style="border-collapse: collapse; width: 100%; margin: 16px 0;">
          ...
          <tr>
            ...
            <td style="padding: 10px 14px; border: 1px solid #ddd; color: #555;">英语面试，需全程使用英语作答</td>
          </tr>
        </table>
...
async function main() {
  const candidateId = 'cand_wzp_003_new';
  const formLink = generateTimeSelectLink(candidateId);
  const candidate = {
    name: '汪展鹏',
  ...
  console.log(`面试链接: ${candidate.formLink}`);
